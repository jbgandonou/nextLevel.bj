...
export const phase03Questions: QuizQuestion[] = [
  ...
  // === SBOM extra questions (p3-q41 to p3-q48) ===
  {
    id: 'p3-q41',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Qu\'est-ce qu\'un SBOM (Software Bill of Materials) ?',
    options: [
      'Un outil de compilation de code source',
      'Un inventaire complet et structuré de tous les composants qui constituent un logiciel',
      'Un rapport de tests de performance',
      'Un document de spécification fonctionnelle',
    ],
    correctIndex: 1,
    explanation: 'Un SBOM est un inventaire détaillé listant tous les composants d\'un logiciel : bibliothèques, frameworks, dépendances transitives, avec leurs versions exactes et licences. Pour un projet ML, il inclut aussi les modèles pré-entraînés et les datasets. C\'est essentiel pour la gestion des vulnérabilités de la supply chain.',
    difficulty: 'easy',
  },
  {
    id: 'p3-q42',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Quels sont les deux formats standards dominants pour les SBOM ?',
    options: [
      'JSON et XML',
      'SPDX et CycloneDX',
      'CSV et YAML',
    ...
    correctIndex: 1,
    explanation: 'SPDX (Software Package Data Exchange) est un standard ISO/IEC 5962:2021, axé sur les licences et la conformité. CycloneDX est un format OWASP optimisé pour la sécurité avec un support natif des vulnérabilités et des dépendances. Les deux peuvent être générés en JSON, XML ou d\'autres formats.',
    difficulty: 'easy',
  },
  {
    id: 'p3-q43',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Pourquoi un SBOM est-il particulièrement important pour les projets ML ?',
    options: [
      'Pour accélérer l\'entraînement des modèles',
      'Pour tracer les dépendances (bibliothèques, modèles pré-entraînés, datasets) et identifier rapidement les vulnérabilités de la supply chain',
      'Pour réduire la taille des conteneurs Docker',
      'Pour améliorer la précision des modèles',
    ],
    correctIndex: 1,
    explanation: 'Les projets ML ont des supply chains complexes : bibliothèques (TensorFlow, PyTorch), modèles pré-entraînés (Hugging Face), datasets, et images Docker. Un SBOM permet d\'identifier rapidement si une vulnérabilité critique (comme Log4Shell) affecte un composant du projet, et de tracer l\'origine de chaque artefact.',
    difficulty: 'medium',
  },
  {
    id: 'p3-q44',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Quel outil permet de générer un SBOM à partir d\'une image Docker ?',
    options: [
      'Docker Compose',
      'Syft ou Trivy',
      'Kubernetes kubectl',
    ...
    correctIndex: 1,
    explanation: 'Syft (d\'Anchore) analyse les images Docker pour produire un SBOM détaillé de tous les packages installés. Trivy (d\'Aqua Security) peut à la fois générer un SBOM et scanner les vulnérabilités. La commande typique : "syft mon-image:latest -o cyclonedx-json > sbom.json".',
    difficulty: 'medium',
  },
  {
    id: 'p3-q45',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Qu\'est-ce que la signature de modèle ML et quel problème résout-elle ?',
    options: [
      'La signature du contrat de licence du modèle',
      'La signature cryptographique qui garantit l\'intégrité et l\'authenticité du modèle, empêchant les modifications non autorisées',
      'La signature du développeur dans les commentaires du code',
      'L\'empreinte digitale utilisée pour l\'authentification biométrique',
    ],
    correctIndex: 1,
    explanation: 'La signature cryptographique d\'un modèle ML (via Sigstore/cosign, GPG ou des hashes SHA-256) garantit que le modèle n\'a pas été modifié (intégrité) et provient d\'une source autorisée (authenticité). Cela protège contre les attaques de supply chain comme l\'injection de backdoors dans les modèles.',
    difficulty: 'medium',
  },
  {
    id: 'p3-q46',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Comment intégrer la vérification du SBOM dans un pipeline CI/CD pour un projet ML ?',
    options: [
      'Vérifier manuellement le SBOM avant chaque release',
      'Générer automatiquement le SBOM à chaque build, scanner les vulnérabilités et bloquer le déploiement si des CVE critiques sont détectées',
      'Stocker le SBOM dans un fichier texte sur le bureau du développeur',
      'Générer le SBOM uniquement lors des audits annuels',
    ],
    correctIndex: 1,
    explanation: 'L\'intégration CI/CD du SBOM suit le pattern : 1) Générer le SBOM automatiquement (cyclonedx-bom, syft), 2) Scanner les vulnérabilités (grype, trivy), 3) Appliquer une politique de gate (bloquer si CVE critique), 4) Archiver le SBOM comme artefact de build, 5) Vérifier les signatures des dépendances.',
    difficulty: 'hard',
  },
  {
    id: 'p3-q47',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Qu\'est-ce que Sigstore et comment est-il utilisé pour sécuriser les artefacts ML ?',
    options: [
      'Un outil de chiffrement de données au repos',
      'Un système de signature sans clé (keyless signing) qui utilise des certificats éphémères liés à l\'identité OIDC pour signer et vérifier des artefacts',
      'Un service de stockage sécurisé pour les modèles ML',
      'Un framework de test de sécurité pour les API',
    ],
    correctIndex: 1,
    explanation: 'Sigstore (cosign, rekor, fulcio) permet la signature sans clé persistante. L\'utilisateur s\'authentifie via OIDC (GitHub, Google), reçoit un certificat éphémère de Fulcio, signe l\'artefact, et la signature est enregistrée dans le transparency log Rekor. Pour les modèles ML, cela garantit la traçabilité complète de l\'origine.',
    difficulty: 'hard',
  },
  {
    id: 'p3-q48',
    phaseId: 'phase-03',
    lessonId: 'p3-sbom',
    question: 'Quel décret américain a rendu les SBOM obligatoires pour les fournisseurs de logiciels du gouvernement fédéral ?',
    options: [
      'Le PATRIOT Act',
      'L\'Executive Order 14028 sur l\'amélioration de la cybersécurité nationale (mai 2021)',
      'Le GDPR américain',
      'La loi Sarbanes-Oxley',
    ],
    correctIndex: 1,
    explanation: 'L\'Executive Order 14028 signé en mai 2021 exige que les fournisseurs de logiciels du gouvernement fédéral américain fournissent un SBOM. Cela a accéléré l\'adoption des SBOM dans l\'industrie. Le NTIA a publié les exigences minimales : composants, versions, relations de dépendance, auteur et timestamp.',
    difficulty: 'hard',
  },
];
